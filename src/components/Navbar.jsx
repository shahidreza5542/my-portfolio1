...
const Navbar = () => {
  ...
  return (
    <nav className="z-100 border-b-[0.5px] border-white/20 backdrop-blur-md w-full text-white justify-between flex items-center py-4 md:px-20 px-4 fixed top-0">
