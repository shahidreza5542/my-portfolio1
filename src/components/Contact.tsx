...
export default function Contact() {
  return (
    <motion.section 
      ...
      className="relative min-h-screen bg-black overflow-hidden py-24 md:py-32 border-t border-white/5" 
      id="contact"
    >
      <div className="absolute inset-0 grid-pattern opacity-10 pointer-events-none" />
      
      <div className="container mx-auto px-6 md:px-24 h-full">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 md:gap-24 h-full items-center">
          <div className="space-y-12">
            <div>
              ...
              <h2 className="text-5xl md:text-9xl text-white leading-none">
                LET'S <br />
          ...
          <div className="relative">
            <div className="p-6 md:p-12 border border-white/10 bg-surface-raised relative z-10 space-y-8">
